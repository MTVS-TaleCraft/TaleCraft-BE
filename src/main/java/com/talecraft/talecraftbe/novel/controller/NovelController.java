...
public class NovelController {
    ...
    //전체 조회
    @GetMapping()
    public ResponseEntity<ResponseGetNovelListDto> getAllNovels(@RequestParam(value = "value",required = false) String keyword,@RequestParam(value="type", required=false) String type, @AuthenticationPrincipal User user) {
            return novelService.getNovelList(keyword,type, user);
    }
